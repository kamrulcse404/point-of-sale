...
@section('content')
    <div>
        <div class="row justify-content-md-center">
            <div class="col-md-4">
                <h4 class="mb-3 text-gray-800">Edit Group</h4>
            </div>
                        ...
                        <form action="{{ route('groups.update', $group->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="title" name="title" class="form-control" id="title"
                                    placeholder="Enter group title" value="{{ $group->title }}" required>
                                @error('title')
                                    <p class="text-danger mt-2">{{ $message }}</p>
                                @enderror
                            </div>

                            <button type="submit" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square"></i>
                                Group</button>
                        </form>
                    </div>
                </div>
